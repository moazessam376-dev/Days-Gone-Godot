...
# injects the same input a player would, and captures viewport PNGs of each
# state the user flagged. Camera positions are model-facing-relative so
# "front" stays the character's front in every state.

const OUT := "/private/tmp/claude-501/-Users-moazessam-Projects-Godot-days-gone/19b46570-29ce-4e44-8cd2-781872f719b0/scratchpad/shots"
